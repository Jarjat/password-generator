...
class password:
	def __init__(self, window):
		...
		Label(frame, text = 'Select a Characters: ').grid(row = 1, column = 0, pady = (6, 0), sticky = W)
		...
		# Password Length
		Label(frame, text = 'Select a Length:').grid(row = 3, column = 0, pady = (6, 0), sticky = W)
		...
		ttk.Button(frame, text = 'Generar', command = self.generate_password).grid(row = 7, column = 0, pady = (6, 0), sticky = W + E)
